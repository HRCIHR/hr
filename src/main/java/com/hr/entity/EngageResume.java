...
public class EngageResume {
	...
	private BigDecimal demand_Salary_Standard;
	...
	private Date test_CheckTime;

	private String pass_Register;

	private Date pass_RegistTime;

	private String pass_Checker;

	private Date pass_CheckTime;

	private Integer pass_CheckStatus;
	...
	public Date getRegis_tTime() {
		return regist_Time;
	}

	public void setRegis_tTime(Date regis_tTime) {
		this.regist_Time = regis_tTime;
	}
	...
	public Date getTest_CheckTime() {
		return test_CheckTime;
	}

	public void setTest_CheckTime(Date test_CheckTime) {
		this.test_CheckTime = test_CheckTime;
	}
	...
	public Date getPass_RegistTime() {
		return pass_RegistTime;
	}

	public void setPass_RegistTime(Date pass_RegistTime) {
		this.pass_RegistTime = pass_RegistTime;
	}
	...
	public Date getPass_CheckTime() {
		return pass_CheckTime;
	}

	public void setPass_CheckTime(Date pass_CheckTime) {
		this.pass_CheckTime = pass_CheckTime;
	}

	public Integer getPass_CheckStatus() {
		return pass_CheckStatus;
	}

	public void setPass_CheckStatus(Integer pass_CheckStatus) {
		this.pass_CheckStatus = pass_CheckStatus;
	}
	...
	public String toString() {
		return "EngageResume [res_Id=" + res_Id + ", human_Name=" + human_Name + ", engage_Type=" + engage_Type
				+ ", human_Address=" + human_Address + ", human_Postcode=" + human_Postcode + ", human_Major_Id="
				+ human_Major_Id + ", human_Telephone=" + human_Telephone + ", human_Homephone=" + human_Homephone
				+ ", human_Mobilephone=" + human_Mobilephone + ", human_Email=" + human_Email + ", human_Hobby="
				+ human_Hobby + ", human_Specility=" + human_Specility + ", human_Sex=" + human_Sex
