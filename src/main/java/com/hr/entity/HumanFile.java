...
//	private ConfigPublicChar publicChar;
...
//	public ConfigPublicChar getPublicChar() {
//		return publicChar;
//	}
//
//	public void setPublicChar(ConfigPublicChar publicChar) {
...
//	}
	...
	public String toString() {
		return "HumanFile [human_Id=" + human_Id + ", first_Kind_Id=" + first_Kind_Id + ", second_Kind_Id="
				+ second_Kind_Id + ", third_Kind_Id=" + third_Kind_Id + ", human_Name=" + human_Name
				+ ", human_Address=" + human_Address + ", human_Postcode=" + human_Postcode + ", human_Pro_Designation="
				+ human_Pro_Designation + ", human_Major_Id=" + human_Major_Id + ", human_Telephone=" + human_Telephone
				...
				+ human_Id_Card + ", salary_Standard_Id=" + salary_Standard_Id + ", salary_Sum=" + salary_Sum
				...
				+ ", human_Picture=" + human_Picture + ", attachment_Name=" + attachment_Name + ", check_Status="
				+ check_Status + ", register=" + register + ", checker=" + checker + ", changer=" + changer
				+ ", regist_Time=" + regist_Time + ", check_Time=" + check_Time + ", change_Time=" + change_Time
				+ ", lastly_Change_Time=" + lastly_Change_Time + ", delete_Time=" + delete_Time + ", recovery_Time="
				+ recovery_Time + ", human_File_Status=" + human_File_Status + ", remark=" + remark
				+ ", human_Histroy_Records=" + human_Histroy_Records + ", human_Family_Membership="
				+ human_Family_Membership + ", thirdKind=" + thirdKind + ", Major=" + Major + "]";
	}
